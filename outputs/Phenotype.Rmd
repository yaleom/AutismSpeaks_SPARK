...
for(ncol in 10:ncol(phe)){
  ...
  ##adjust IQ 
  phe_resids <- resid(lm(Y ~ Age +  FSIQ + chip, data = dat, na.action=na.exclude))
  ...
  ##Without adjust IQ
  phe_resid2 <- resid(lm(Y ~ Age +  chip, data = dat, na.action=na.exclude))
  Tmp2 <- data.frame(phe_m2[,c("FID", "IID", "sex")], phe_resid2)
  for(i in levels(factor(Tmp2$sex))){
...
grid.raster(readPNG("figures/primary_probands_Notadj.png"))
```
...
grid.raster(readPNG("figures/primary_probands_adj.png"))
```
...
grid.raster(readPNG("figures/primary_probands_adjAndPCs.png"))
```
...
grid.raster(readPNG("figures/secondary_probands_Notadj.png"))
```
...
grid.raster(readPNG("figures/secondary_probands_adj.png"))
```
...
grid.raster(readPNG("figures/secondary_probands_adjAndPCs.png"))
```
...
grid.raster(readPNG("figures/UnaffSibs_shared_Notadj.png"))
```
...
grid.raster(readPNG("figures/UnaffSibs_shared_adj.png"))
```
...
grid.raster(readPNG("figures/UnaffSibs_shared_adjAndPCs.png"))
```
...
```{r re-adjust phenotypes including ASD, eval=FALSE, include=FALSE}
setwd("/scratch/90days/uqywan67/auti_proj/SSC/phenotypes")

pcs <- read.table("/afm01/UQ/Q3490/SSC/grm/SSC_imputed_autosome_info.3_pruned.3_pca20.eigenvec", stringsAsFactors = F)
names(pcs) <- c("FID", "IID", paste0("PC", 1:20))

phe <- read.table("phe_probandsCombunaffSibs_raw.txt", header = T, stringsAsFactors = F)
# phe$ASD <- 1
# phe[phe$Group == "Probands", "ASD"] <- 2

qcovs <- read.table("qcov_probSibs.txt", stringsAsFactors = F)
covs <- read.table("sexAndchip.txt", stringsAsFactors = F)
# covs$ASD <- phe[match(covs$V2, phe$IID), "ASD"]
# write.table(covs, file = "sexAndchip.txt", col.names = F, row.names = F, quote = F, sep = "\t")

names(qcovs) <- c("FID", "IID",  paste0("PC", 1:20), "Age", "FSIQ")
names(covs) <- c("FID", "IID", "sex", "chip", "ASD")

phe_m1 <- merge(x = phe, y = qcovs, id = c("FID", "IID", "sex"), all.x = T )
phe_m2 <- merge(x = phe_m1, y = covs[,-3], id = c("FID", "IID"), all.x = T )

xnam <- paste("PC", 1:20, sep="")

phe_adj1 <- phe_adj2 <- phe_adj3 <- phe_adj4 <-phe_m2[,c("FID", "IID", "Group", "sex")]

for(ncol in 5:18){
  y <- colnames(phe)[ncol]
  dat <- phe_m2[,c(y, "Age", "sex", "FSIQ", "chip", "ASD", paste0("PC", 1:20))]
  names(dat)[1] <- "Y"
  
  ##adjust IQ 
  #phe_resids <- resid(lm(Y ~ Age + FSIQ + chip + ASD, data = dat, na.action=na.exclude))
  # Tmp <- data.frame(phe_m2[,c("FID", "IID", "sex")], phe_resids)
  # for(i in levels(factor(Tmp$sex))){
  #   Tmp[Tmp$sex == i, "phe_resids"]<- qnorm((rank(Tmp[Tmp$sex == i,]$phe_resids,na.last="keep") - 0.5)/sum(!is.na(Tmp[Tmp$sex == i,]$phe_resids))) 
  # }
  # phe_rint <- Tmp[match(phe_adj1$IID, Tmp$IID), "phe_resids"]
  # phe_adj1[,(ncol)] <- phe_rint
  # names(phe_adj1)[(ncol)] <- y
  
  # ##Without adjust IQ
 # phe_resid2 <- resid(lm(Y ~ Age + chip + ASD, data = dat, na.action=na.exclude))
  phe_resid2 <- resid(lm(Y ~ chip + ASD, data = dat, na.action=na.exclude))
  ...
  phe_rint <- Tmp2[match(phe_adj2$IID, Tmp2$IID), "phe_resid2"]
  phe_adj2[,(ncol)] <- phe_rint
  names(phe_adj2)[(ncol)] <- y
  
  ##adjust IQ and PCs
  # fmla <- as.formula(paste("Y ~ Age + FSIQ + chip + ASD +", paste(xnam, collapse= "+") ))
  # 
  # phe_resid3 <- resid(lm(fmla, data = dat, na.action=na.exclude))
  # ##RINT within sex
  # tmp3 <- data.frame(phe_m2[,c("FID", "IID", "sex")], phe_resid3)
  ...
  # }
  # phe_rint3 <- tmp3[match(phe_adj3$IID, tmp3$IID), "phe_resid3"]
  # phe_adj3[,(ncol)] <- phe_rint3
  # names(phe_adj3)[(ncol)] <- y
  
  ##adjust PCs but without IQ
  #fmla2 <- as.formula(paste("Y ~ Age +  chip + ASD + ", paste(xnam, collapse= "+") ))
  fmla2 <- as.formula(paste("Y ~ chip + ASD + ", paste(xnam, collapse= "+") ))
  ...
  phe_rint4 <- tmp4[match(phe_adj4$IID, tmp4$IID), "phe_resid4"]
  phe_adj4[,(ncol)] <- phe_rint4
  names(phe_adj4)[(ncol)] <- y
}

#write.table(phe_adj1, file = "phe_adjWithIQ_probSibs.txt", col.names = T, row.names = F, quote = F, sep = "\t")
write.table(phe_adj2, file = "phe_adjWithoutIQ_probSibs.txt", col.names = T, row.names = F, quote = F, sep = "\t")
#write.table(phe_adj3, file = "phe_adjPCsWithIQ_probSibs.txt", col.names = T, row.names = F, quote = F, sep = "\t")
write.table(phe_adj4, file = "phe_adjPCsWithoutIQ_probSibs.txt", col.names = T, row.names = F, quote = F, sep = "\t")
...
- combined phenotypes are pre-adjusted by sex, chip and ASD diagnosis
...
```{r plot_noPCs_ASD, include=FALSE, eval=FALSE}
setwd("/afm01/UQ/Q3490/SSC/phenotypes")
phes1 <- read.table("phe_probandsCombunaffSibs_raw.txt", header = T, stringsAsFactors = F)
#phes2 <- read.table("phe_adjWithIQ_probSibs.txt", header = T, stringsAsFactors = F)
phes3 <- read.table("phe_adjWithoutIQ_probSibs.txt", header = T, stringsAsFactors = F)
library(reshape2)
library(ggplot2)
phes1_2 <- melt(phes1, id = c("FID", "IID", "individual", "sex", "Group"))
#phes2_2 <- melt(phes2, id = c("FID", "IID",  "sex", "Group"))
phes3_2 <- melt(phes3, id = c("FID", "IID", "sex", "Group"))
phes1_2 <- phes1_2[grep("sum", phes1_2$variable),]
#phes2_2 <- phes2_2[grep("sum", phes2_2$variable),]
phes3_2 <- phes3_2[grep("sum", phes3_2$variable),]
...
ggsave(file.path("/scratch/90days/uqywan67/auti_proj/SSC/outputs/probandsAndunaffSibs_adjnoIQ_ASD.png"), plot_phes3_2, height = 6, width = 12, dpi = 300)
...
ggsave(file.path("/scratch/90days/uqywan67/auti_proj/SSC/outputs/probandsAndunaffSibs_adjnoIQII_ASD.png"), plot_phes3_2II, height = 6, width = 12, dpi = 300)

```

```{r plot_wthPCs_ASD, eval=F, include=F}
setwd("/afm01/UQ/Q3490/SSC/phenotypes")
phes1 <- read.table("phe_probandsCombunaffSibs_raw.txt", header = T, stringsAsFactors = F)
#phes2 <- read.table("phe_adjPCsWithIQ_probSibs.txt", header = T, stringsAsFactors = F)
phes3 <- read.table("phe_adjPCsWithoutIQ_probSibs.txt", header = T, stringsAsFactors = F)
library(reshape2)
library(ggplot2)
phes1_2 <- melt(phes1, id = c("FID", "IID", "individual", "sex", "Group"))
#phes2_2 <- melt(phes2, id = c("FID", "IID",  "sex", "Group"))
...
ggsave(file.path("/scratch/90days/uqywan67/auti_proj/SSC/outputs/probandsAndunaffSibs_adjnoIQ_withPCs_ASD.png"), plot_phes3_2, height = 6, width = 12, dpi = 300)
...
ggsave(file.path("/scratch/90days/uqywan67/auti_proj/SSC/outputs/probandsAndunaffSibs_adjnoIQII_withPCs_ASD.png"), plot_phes3_2II, height = 6, width = 12, dpi = 300)
...
grid.raster(readPNG("figures/probandsAndunaffSibs_raw.png"))
```
...
<!-- #### Fitting IQ -->
<!-- ```{r  out.width="100%", out.height="100%", dpi=300} -->
<!-- grid.raster(readPNG("figures/probandsAndunaffSibs_adjIQ_ASD.png")) -->
<!-- ``` -->
...
<!-- #### Not Fitting IQ -->
```{r  out.width="100%", out.height="100%", dpi=300}
grid.raster(readPNG("figures/probandsAndunaffSibs_adjnoIQ_ASD.png"))
```
...
<!-- #### Fitting IQ -->
<!-- ```{r  out.width="100%", out.height="100%", dpi=300} -->
<!-- grid.raster(readPNG("figures/probandsAndunaffSibs_adjIQ_withPCs_ASD.png")) -->
<!-- ``` -->
...
<!-- #### Not Fitting IQ -->
```{r  out.width="100%", out.height="100%", dpi=300}
grid.raster(readPNG("figures/probandsAndunaffSibs_adjnoIQ_withPCs_ASD.png"))
```
...
### Raw
```{r  out.width="100%", out.height="100%", dpi=300}
grid.raster(readPNG("figures/probandsAndunaffSibs_rawII.png"))
```
...
<!-- #### Fitting IQ -->
<!-- ```{r  out.width="100%", out.height="100%", dpi=300} -->
<!-- grid.raster(readPNG("figures/probandsAndunaffSibs_adjIQII_ASD.png")) -->
<!-- ``` -->
...
<!-- #### Not Fitting IQ -->
```{r  out.width="100%", out.height="100%", dpi=300}
grid.raster(readPNG("figures/probandsAndunaffSibs_adjnoIQII_ASD.png"))
```
...
<!-- #### Fitting IQ -->
<!-- ```{r  out.width="100%", out.height="100%", dpi=300} -->
<!-- grid.raster(readPNG("figures/probandsAndunaffSibs_adjIQII_withPCs_ASD.png")) -->
<!-- ``` -->
...
<!-- #### Not Fitting IQ -->
```{r  out.width="100%", out.height="100%", dpi=300}
grid.raster(readPNG("figures/probandsAndunaffSibs_adjnoIQII_withPCs_ASD.png"))
```
...
```{r cor_pcs_phenotype, eval=F, include=F}
setwd("~/delta2/auti_proj/SSC/phenotypes")

phe1 <- read.table("phe_adjWithIQ_probands.txt", header = T, stringsAsFactors = F)
phe2 <- read.table("phe_adjWithoutIQ_probands.txt", header = T, stringsAsFactors = F)
pcs <- read.table("../grm/SSC_imputed_autosome_info.3_pruned.3_pca20.eigenvec", stringsAsFactors = F)

eurs <- read.table("../grm/Probands_matchedID_cleaned_EUR.ids")
names(pcs) <- c("FID", "IID", paste0("PC", 1:20))

phe1_2 <- merge(x = phe1, y = pcs, id = c("FID", "IID"), all.x = T)
phe2_2 <- merge(x = phe2, y = pcs, id = c("FID", "IID"), all.x = T)

phenames <- grep("sum", colnames(phe1))

for(ncol in phenames){
  phename <- colnames(phe1)[ncol]
  dat <- phe1_2[,c(1:2, ncol, 57:61)]
  names(dat)[3] <- "Y"
  fits <- summary(lm(Y ~ PC1 + PC2 + PC3 + PC4 + PC5, data = dat))
  print(fits)
  print(paste0("================", phename, "================"))
}

for(ncol in phenames){
  phename <- colnames(phe1)[ncol]
  dat <- phe2_2[,c(1:2, ncol, 57:61)]
  names(dat)[3] <- "Y"
  fits <- summary(lm(Y ~ PC1 + PC2 + PC3 + PC4 + PC5, data = dat))
  print(fits)
  print(paste0("================", phename, "================"))
...
phe_probSibs1 <- read.table("phe_adjWithoutIQ_probSibs.txt", header = T, stringsAsFactors = F)
pcs <- read.table("../grm/SSC_imputed_autosome_info.3_pruned.3_pca20.eigenvec", stringsAsFactors = F)

names(pcs) <- c("FID", "IID", paste0("PC", 1:20))

phe_probSibs1_2 <- merge(x = phe_probSibs1, y = pcs, id = c("FID", "IID"), all.x = T)

phe_probSibsnames <- grep("sum", colnames(phe_probSibs1))

for(ncol in phe_probSibsnames){
  phe_probSibsname <- colnames(phe_probSibs1)[ncol]
  dat <- phe_probSibs1_2[,c(1:2, ncol, 19:23)]
  names(dat)[3] <- "Y"
  fits <- summary(lm(Y ~ PC1 + PC2 + PC3 + PC4 + PC5, data = dat))
  print(fits)
  print(paste0("================", phe_probSibsname, "================"))
}
