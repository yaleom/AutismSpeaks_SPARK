...
genodir="/afm01/UQ/Q3457/AGP/hrc_imputed/QCd/" ##genotype dir
outdir="/afm01/UQ/Q3457/AGP/hrc_imputed/QCd/grm/"  ## grm output dir
scriptdir="/scratch/90days/uqywan67/auti_proj/AGP/scripts/" ##script dir for weight_frq
bfile="AGP_imputed_autosome_geno.05_maf.01_hwe1e-6_info.3" ##bfile prefix
projc="AGP" ##cohort name for cohort to be projected
...
system(paste0("plink --bfile ",  data, "  --extract /afm01/UQ/Q3457/SSC/hrc_imputed/QCd/hapmap3_autosome.snplist  --indep-pairwise 100 50 ", r2, " --threads 4 --out ", outdir, bfile, "_qcd_pruned", r2))
