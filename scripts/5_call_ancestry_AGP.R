...
grmdir="/afm01/UQ/Q3457/AGP/hrc_imputed/QCd/grm/" 
projc="AGP" ##cohort to be assigned
...
## get parameters
spop  <- read.table("1kg_pop2504.txt",header=TRUE,stringsAsFactors=FALSE) ##note the FID is unique
...
write.table(toAssign, file = "agp_anc.txt", col.names = T, row.names = F, quote = F)
